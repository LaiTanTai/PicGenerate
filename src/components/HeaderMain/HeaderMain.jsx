  ...
  return (
    ...
    <div style={{position:'fixed',width:"100%",zIndex:"10"}}>
        <div className={styles.navbar}>
            ...
            <button className={styles.generate}><img src='./img/star.svg' alt='star'/>Generate</button>
