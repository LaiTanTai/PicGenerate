    ...
    <div style={{position:'fixed',width:"100%",zIndex:"10"}}>
        <div className={styles.navbar}>
            ...
            <div className={styles.User}>
              ...
              {logoutOpen ?<div style={{position:'absolute',top:'100%',left:'20%',width:'200px',height:'fit-content',zIndex:'11',backgroundColor:'white',border:'rgb(4, 11, 53) 2px solid',borderRadius:'10px'}}>
